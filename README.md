...
<body>
    <div class="container-fluid bg-dark">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="#">GRACEA OLIVIA</a>
    ...
    <div class="container">
        <div class="my-4 mb-5 d-flex">
            <div class="col-md-4">
                <img src="https://jatenglive.com/images/news/Lyodra-Rilis-Album-dan-Video-Dengan-Tema-Ghosting-news20210716-1047756218.jpg"
                    class="img-thumbnail " alt="...">

                <table class="table table-borderless">
                    <tbody>
                        <tr>
                            <td class="fs-6 fw-bold">Title :</td>
                            <td class="fs-6">Lyodra - Pesan Terakhir (Official Music Video)</td>
                        </tr>
                        <tr>
                            <td class="fs-6 fw-bold">Channel Youtobe :</td>
                            <td class="fs-6">Lyodra Official</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="col-md-8 mx-2" id="main">
                <video id='hls-video'>
                    <source src='Lyodra.mp4' type='video/mp4' />
                </video>
                <script>
                    fluidPlayer(
                        'hls-video', {
        ...
        <div class="container">
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                <div class="col-md-4 d-flex align-items-center">
                    ...
                    <span class="text-muted">&copy; 2021 UKRIM University</span>
                </div>
